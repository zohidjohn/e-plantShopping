  ...
  return (
    <div className="about-us-container">
      ...
      <p className="about-us-description">
        Welcome to Ziad&apos;s Plants, where green meets serenity!
      </p>
      <p className="about-us-content">
        At Ziad&apos;s Plants, we offer a wide variety of lush, healthy plants,
        from resilient succulents and delicate orchids to robust trees and
        vibrant flowering plants, each carefully selected to thrive in your
        specific environment. Our user-friendly website provides detailed care
        instructions, gardening tips, and expert advice to ensure your plants
        flourish. Whether you&apos;re an experienced gardener or just starting
        your green journey, Ziad&apos;s Plants is your trusted partner in
        cultivating a verdant and thriving oasis. Join our community of plant
        enthusiasts and let Ziad&apos;s Plants help you grow a greener world.
      </p>
      ...
      <p className="about-us-content">
        ...
        Ziad&apos;s Plants today and experience the beauty of nature right at
        your doorstep.
      </p>
    </div>
  );
